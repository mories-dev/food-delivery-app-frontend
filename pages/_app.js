...
class MyApp extends App {
  ...
  render() {
    ...
    return (
      <AppContext.Provider value={{user: this.state.user, setUser: this.setUser, addItem: this.addItem, cart: this.state.cart, removeItem: this.removeItem }}>
      <>
        <Head>
        <link
          rel="stylesheet"
